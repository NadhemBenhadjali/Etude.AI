// src/main/java/com/example/EtudeAI/service/keycloak/KeycloakAdminClient.java
        ...
        return keycloak.post()
                ...
                .exchangeToMono(resp -> {
                    ...
                    return resp.bodyToMono(String.class).flatMap(body ->
                            Mono.error(new IllegalStateException("Keycloak create user failed: " + resp.statusCode() + " - " + body)));
                })
                .block();
    }
